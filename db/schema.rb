...
ActiveRecord::Schema[7.1].define(version: 2025_03_03_061850) do
  ...
  create_table "closet_items", force: :cascade do |t|
    ...
    t.index ["product_id"], name: "index_closet_items_on_product_id"
  ...
  create_table "outfits", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.vector "top_embedding", limit: 1536
    t.vector "bottom_embedding", limit: 1536
    t.vector "shoes_embedding", limit: 1536
  ...
  add_foreign_key "closet_items", "products"
